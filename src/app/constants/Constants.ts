...
export const nav_array = [
    ...
    {id: 4, value: 'Позвонить', href: 'Author_new/pages/contacts'},
]
export const services_array = [
    {id: 0, value: light_boxes, alt: 'Световые короба', href: 'Author_new/pages/services/light-boxes'},
    {id: 1, value: signs, alt: 'Вывески', href: 'Author_new/pages/services/signs'},
    {id: 2, value: large_format_printing, alt: 'Широкоформатная печать', href: 'Author_new/pages/services/large-format-printing'},
    {id: 3, value: roof_installations, alt: 'Крышные установки', href: 'Author_new/pages/services/roof-installations'},
    {id: 4, value: interior_designs, alt: 'Интерьерное оформление', href: 'Author_new/pages/services/interior-designs'},
    {id: 5, value: volumetric_letters, alt: 'Обьемные буквы', href: 'Author_new/pages/services/volumetric-letters'},
    {id: 6, value: advertising_signs, alt: 'Рекламные штендеры', href: 'Author_new/pages/services/advertising-signs'},
    {id: 7, value: tables, alt: 'Таблички', href: 'Author_new/pages/services/tables'},
    {id: 8, value: life_figures, alt: 'Ростовые фигуры', href: 'Author_new/pages/services/life-figures'},
    {id: 9, value: advertising_stands, alt: 'Рекламные стойки', href: 'Author_new/pages/services/advertising-stands'},
    {id: 10, value: exhibition_stands, alt: 'Выставочные стенды', href: 'Author_new/pages/services/exhibition-stands'},
    {id: 11, value: panel_bracket, alt: 'Панель кронштейн', href: 'Author_new/pages/services/panel-bracket'},
    {
        id: 12,
    ...
    {id: 13, value: information_stands, alt: 'Информационные стенды', href: 'Author_new/pages/services/information-stands'},
    {id: 14, value: advertising_designs, alt: 'Рекламные конструкции', href: 'Author_new/pages/services/advertising-designs'},
    {id: 15, value: milling, alt: 'Фрезеровка', href: 'Author_new/pages/services/milling'},
    {id: 16, value: laser_cutting, alt: 'Дазерная резка', href: 'Author_new/pages/services/laser-cutting'},
    {id: 17, value: engraving, alt: 'Гравировка', href: 'Author_new/pages/services/engraving'},
    {id: 18, value: threeD_modeling, alt: '3д моделированние', href: 'Author_new/pages/services/threeD-modeling'},
    {id: 19, value: souvenir_products, alt: 'Сувенирная продукция', href: 'Author_new/pages/services/souvenir-products'},
    {id: 20, value: design_services, alt: 'Услуги дизайна', href: 'Author_new/pages/services/design-services'},
    {id: 21, value: stickers, alt: 'Стикеры', href: 'Author_new/pages/services/stickers'},
]
